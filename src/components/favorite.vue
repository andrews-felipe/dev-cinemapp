      ...
      <div class="wrapper_content__inner">
        ...
        <label for="click">
          <div class="favourite">
            ...
            <div class="favourite_heart" v-if="view">
              <div class="favourite_heart__left"></div>
              <div class="favourite_heart__right"></div>
            </div>
            <div v-if="view" class="favourite_text" @click="$emit('add-favorite')">
              <span>Add Favoritos</span>
            </div>
            <div v-else class="favourite_text" @click="$emit('remove-favorite'); set()">
              <span>Remover</span>
            </div>
          </div>
        </label>
...
@media only screen and (max-height: 330px) {
  // Checks how the pen will look in featured iframe
  body {
    //  background:Red;
  }
}
